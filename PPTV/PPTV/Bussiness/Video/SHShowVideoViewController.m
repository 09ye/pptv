...
- (void)applicationDidEnterForeground:(NSNotification *)notification
{
    ...
    if (![mMPayer isPlaying]) {
		[mMPayer start];
        [self.startPause setImage:[UIImage imageNamed:@"mediacontroller_pause"] forState:UIControlStateNormal];
...
- (void)mediaPlayer:(VMediaPlayer *)player bufferingStart:(id)arg
{
	...
	if (![Utilities isLocalMedia:self.videoURL]) {
		[player pause];
        [self.startPause setImage:[UIImage imageNamed:@"mediacontroller_play"] forState:UIControlStateNormal];
